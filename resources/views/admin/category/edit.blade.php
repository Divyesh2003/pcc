    ...
    <main id="main" class="main">
        <section class="section">
          <div class="row">
            <div class="col-lg-12">
              <div class="card">
                <form name="category" id="category" class="needs-validation"
        ...
        <div class="intro-y box p-1">
            ...
            <div class="input-form  @error('name') has-error @enderror">
                ...
                <input id="name" type="text" name="name"
                    ...
                    placeholder="Categoery name" required>
                @error('name')
                <div class="pristine-error text-theme-24 ">{{ $message }}
                </div>
                @enderror
            ...
            <div class="input-form  @error('slug') has-error @enderror">
                ...
                <input id="slug" type="text" name="slug"
                    ...
                    placeholder="Category slug" required pattern= "[a-z\\d]+(?:-[a-z\\d]+)*">
                @error('slug')
                <div class="pristine-error text-theme-24 ">{{ $message }}
                </div>
                @enderror
            ...
            <div
                ...
                <textarea rows="4" cols="50" name="meta_description" class="form-control"
                    placeholder="input meta description">{{ $category->meta_description }}</textarea>
            ...
            <!-- END TAG -->
                ...
                <input id="canonical" type="text" name="canonical"
                    value="{{ $category->canonical }}" class="form-control"
